...
func (r *NotificationRepository) SaveNotification(userID int, tripID int, message string, msgType string) error {
	query := `
		INSERT INTO notifications (user_id, trip_id, message, type, is_read, created_at)
		VALUES ($1, $2, $3, $4, false, NOW())
	`

	_, err := r.db.Exec(query, userID, tripID, message, msgType)
	if err != nil {
